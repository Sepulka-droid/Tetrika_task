...
while True:
    ...
    for line in r.text.split('\n'):
        ...
        if check:
            ...
            # если в animal находится названия отряда, рода и т.п. (например, лжекузнечиковые),
            ...
            # в списке попадаются латинские названия, по условию задачи мы их не учитываем
